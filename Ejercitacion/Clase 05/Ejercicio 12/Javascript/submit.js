function agregarCiudad() {
    ...
    var longitud = Number(document.getElementById("long").value);
    var json = { "_id": id, "name": nombre, "country": pais, "coord": { "lon": longitud, "lat": latitud } };
...
function traerCiudades() {
    ...
    var titulos = ["Id", "Nombre", "País", "Coordenadas", "Action"];
    tabla.createTHead();
    tabla.border = "1";
    for (var i = 0; i < 6; i++) {
